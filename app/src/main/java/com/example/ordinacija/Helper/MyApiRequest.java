...
import com.example.ordinacija.LoginActivity;
                    ...
                    if (result.resultCode == 401)
                    {
                        ...
                        if (result.resultCode == 0) {
                            snackbar = Snackbar.make(parentLayout,
                                    "Greška u komunikaciji sa serverom, provjerite internet konekciju ili pokušajte kasnije!", Snackbar.LENGTH_LONG);
                            ...
                            alertDialog.setMessage("Doslo je do greške, provjerite internet konekciju ili pokušajte kasnije!");
                            alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Pokušajte opet!",
